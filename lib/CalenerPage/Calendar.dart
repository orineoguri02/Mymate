...
class _CalendarState extends State<Calendar> {
  ...
  Object _loadDiaryEntries() {
    final uid = FirebaseAuth.instance.currentUser?.uid;
    if (uid != null) {
      return loadDiaryEntries(uid).listen((entries) {
        if (mounted) {
          setState(() {
...
Stream<Map<DateTime, Map<String, dynamic>>> loadDiaryEntries(String uid) {
